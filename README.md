...
```sh
CLOAKGPT_VERSION=v0.1.0-pre.8 CLOAKGPT_INSTALL_DIR="$HOME/bin" sh install.sh
```

```powershell
.\install.ps1 -Version v0.1.0-pre.8 -InstallDir D:\Tools\CloakGPT
```
...
cloakgpt update --version v0.1.0-pre.8
```
